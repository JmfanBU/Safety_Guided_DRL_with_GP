xvfb-run -a -s "-screen 0 1920x1080x24" python -m SafetyGuided_DRL.run --alg=ddpg_baseline --env=ReacherBL-v2 --network=mlp --num_timesteps=1000 --nb_rollout_steps=50\
